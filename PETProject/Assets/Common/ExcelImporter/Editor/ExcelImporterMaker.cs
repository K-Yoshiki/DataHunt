...
public class ExcelImporterMaker : EditorWindow
{
	...
	private const string EntityTemplate = "Assets/Common/XlsImporter/Editor/EntityTemplate.txt";
	private const string EntityTemplate2 = "Assets/Common/XlsImporter/Editor/EntityTemplate2.txt";
	private const string ExportTemplate = "Assets/Common/XlsImporter/Editor/ExportTemplate.txt";
	private const string ExportTemplate2 = "Assets/Common/XlsImporter/Editor/ExportTemplate2.txt";
	...
	void ExportEntity()
	{
		string templateFilePath = (sepalateSheet) ? EntityTemplate2 : EntityTemplate;
		...
		File.WriteAllText(filePath + className + ".cs", entittyTemplate);
	}
	
	void ExportImporter()
	{
		string templateFilePath = (sepalateSheet) ? ExportTemplate2 : ExportTemplate;
		...
		string exportDir = Path.GetDirectoryName(filePath) + "/DataTables";
		string exportPath = Path.GetDirectoryName(filePath) + "/DataTables/" + Path.ChangeExtension(Path.GetFileName(filePath), ".asset");
		
		Debug.Log(string.Format("importPath = {0}", filePath));
		Debug.Log(string.Format("exportDirectory = {0}", exportDir));
		Debug.Log(string.Format("exportPath = {0}", exportPath));
		...
		Directory.CreateDirectory(Path.GetDirectoryName(filePath) + "/Editor");
		File.WriteAllText(Path.GetDirectoryName(filePath) + "/Editor/" + fileName + "_importer.cs", importerTemplate);
	}
